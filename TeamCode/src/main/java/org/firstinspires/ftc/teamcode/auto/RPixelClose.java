...
@Autonomous
@Config
public class RPixelClose extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        MecanumDrive drive = new MecanumDrive(hardwareMap, new Pose2d(12, -64, 3 * Math.PI / 2));
...
/////////////////////////////////////////////////////
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if(randomization==1){
                ...
                telemetry.update();
                Actions.runBlocking(drive.actionBuilder(new Pose2d(12,-64, 3 * Math.PI / 2))
