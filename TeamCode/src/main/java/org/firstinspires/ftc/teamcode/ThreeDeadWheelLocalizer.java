...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -9614.746651; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 16328.88904; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -11143.73534; // x position of the perpendicular encoder (in tick units)
    }
